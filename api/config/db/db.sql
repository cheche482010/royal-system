...
CREATE TABLE `detalles_orden` (
  ...
  `tipo_precio` enum('unidad','tienda','distribuidor') NOT NULL COMMENT 'Tipo de precio aplicado al producto',
  `precio_bs` decimal(10,2) NOT NULL COMMENT 'Precio  del producto en bolívares ((precio del producto * cantidad de productos)) * tasa_cambio',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creación del registro',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de última actualización',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ordenes` (
  ...
  `is_active` tinyint(1) DEFAULT '1' COMMENT 'Indica si la orden está activo',
  `is_delete` tinyint(1) DEFAULT '0' COMMENT 'Indica si la orden ha sido marcado como eliminado',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creación del registro',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de última actualización',
  PRIMARY KEY (`id`),
...
CREATE TABLE `pagos` (
  ...
  `monto_total` decimal(10,2) NOT NULL COMMENT 'Monto pagado en dólares (cantidad de productos * precio del producto)',
  `monto_total_bs` decimal(10,2) NOT NULL COMMENT 'Monto pagado en bolívares ((monto total en dólares * tasa de cambio))',
