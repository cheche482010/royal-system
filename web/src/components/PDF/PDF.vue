    ...
    <div ref="invoiceContent" class="invoice-content">
      ...
      <div class="info-row">
        ...
        <div class="invoice-details">
          <div><span class="label">Orden de Compra Nro.:</span> {{ invoice.number }}</div>
          <div><span class="label">Forma de pago: CONTADO</span></div>
      ...
      <div class="totals-row">
        ...
        <div class="totals-right">
          ...
          <div><span class="label">Total Operación:</span> <strong>{{ invoice.total.toLocaleString() }}<span> Bs</span></strong></div>
        </div>
      </div>
      <div class="footer-row">
        <div>Factura expresada en: <strong>{{ invoice.currency }}</strong></div>
        <div class="footer-right">Total Operación: <strong>{{ invoice.total.toLocaleString() }}</strong><span> Bs</span></div>
      </div>
    </div>
