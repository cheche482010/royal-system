    ...
    <div class="product-container">
      <div class="product-gallery">
        ...
        <div class="thumbnails">
          <div class="thumbnail active">
            <img :src="productItems[0].image" :alt="'Thumbnail ' + productItems[0].name" />
          </div>
          <div class="thumbnail">
            <img :src="productItems[0].image" :alt="'Thumbnail ' + productItems[0].name" />
          </div>
      ...
      <div class="product-info">
        ...
        <div class="product-price">
          ${{ productItems[0].price.toFixed(2) }}
        </div>
        ...
        <div class="product-section">
          ...
          <p class="composition-text">
            Yellow peas (44%), polo fat (12%), buckwheat, eggs (10%), apple pulp, hydrolyzed salmon protein (7%), salmon
            oil (2%), hydrolyzed chicken liver ( 2%), minerals, eggshells (source of calcium), potassium citrate (0.8%),
