  ...
  <div class="products-container">
    ...
    <div class="products-layout">
      ...
      <div class="products-content">
        ...
        <div class="products-grid" :class="{ 'list-view': viewMode === 'list' }" v-if="filteredProducts.length > 0">
        ...
        <div class="pagination" v-if="totalPages > 1">
          <button class="pagination-button prev" :disabled="currentPage === 1" @click="currentPage--">
            <ChevronLeftIcon class="pagination-icon" />
            Anterior
          </button>

          <div class="pagination-pages">
            <button v-for="page in paginationPages" :key="page" class="page-button"
              :class="{ active: currentPage === page }" @click="currentPage = page">
              {{ page }}
            </button>
          </div>

          <button class="pagination-button next" :disabled="currentPage === totalPages" @click="currentPage++">
            Siguiente
